...
public class SpecialModal extends javax.swing.JFrame{
    public Dimension d;
    private Navegation nv;

    public SpecialModal(JPanel panel, boolean independentLocation) {
        ...
        if(!independentLocation){
            ...
            setLocation(this.getLocation().x,this.getLocation().y-20);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpecialModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SpecialModal().setVisible(true);
            }
        });
    }
