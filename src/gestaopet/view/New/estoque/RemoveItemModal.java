...
public class RemoveItemModal extends ModalPanel {
    //private SpecialModal parent;
    private int itemId;
    public RemoveItemModal(int id) {
        initComponents();        
        Dimension d = new Dimension(340, 150);
        setPreferredSize(d);
        setSize(d);
        start();
        itemId = id;
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestaopet/tema/icons/confirmarP1.png"))); // NOI18N
        ...
        jLabel2.setText("Deseja excluir o Item selecionado?");
