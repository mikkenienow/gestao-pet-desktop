...
public class ReexibirModal extends ModalPanel {
    Financeiro financeiro;

    public ReexibirModal(Financeiro financeiro) {
        initComponents();
    ...
    public void confirm(){
        String t = FinanceiroDB.setHide(this.financeiro,false);
        close();
        V.fin.loadList();
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Reexibir lançamento");
        ...
        jTextArea1.setText("Você está prestes a reexibir este lançamento entre os lançamentos principais, isso significa que ele voltará a ser contablizado junto aos demais lançamentos visíveis.");
